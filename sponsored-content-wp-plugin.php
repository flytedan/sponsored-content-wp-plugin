<?php
/**
 * Plugin Name:       Flytedesk Sponsored Content
 * Plugin URI:        https://flytedesk.com
 * Description:       Publishes flytedesk-managed sponsored/native articles to this site via a REST API, writing correct SEO metadata regardless of which SEO plugin (Yoast, Rank Math, All in One SEO) is active - or none at all.
 * Version:           1.0.0
 ...
 * Text Domain:       flytedesk-sponsored-content
...
define( 'FLYTEDESK_SPONSORED_CONTENT_VERSION', '1.0.0' );
define( 'FLYTEDESK_SPONSORED_CONTENT_FILE', __FILE__ );
define( 'FLYTEDESK_SPONSORED_CONTENT_DIR', plugin_dir_path( __FILE__ ) );
define( 'FLYTEDESK_SPONSORED_CONTENT_URL', plugin_dir_url( __FILE__ ) );
...
if ( ! file_exists( FLYTEDESK_SPONSORED_CONTENT_DIR . 'vendor/autoload.php' ) ) {
	add_action(
		'admin_notices',
		static function (): void {
			printf(
				'<div class="notice notice-error"><p>%s</p></div>',
				esc_html__( 'Flytedesk Sponsored Content is missing its Composer dependencies. Run "composer install --no-dev" in the plugin directory.', 'flytedesk-sponsored-content' )
			);
		}
	);
